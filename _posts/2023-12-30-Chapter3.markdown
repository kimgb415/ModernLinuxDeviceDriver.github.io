...
> Full code in https://github.com/kimgb415/gaby-ldd/tree/Chapter3/Char-Device-Registration
...
> Full code in https://github.com/kimgb415/gaby-ldd/tree/Chapter3/Dynamic-Allocation-of-Major-Numbers
...
![lsmod after scull_load](/assets/img/chapter3/lsmod.png)

Then we run `sudo ./scull_unload` , all stuffs are gone now

![scull_unload](/assets/img/chapter3/unload.png)

# 3.5 open and release

> Full code in https://github.com/kimgb415/gaby-ldd/tree/Chapter3/open-and-release
...
> Full code in https://github.com/kimgb415/gaby-ldd/tree/Chapter3/scull-Memory-Usage
...
For another, `init_MUTEX` is outdated and the new API for semaphore initialization is `sema_init`. Hence, the logic in `scull_init()` is a bit different
...
![O_WRONLY test](/assets/img/chapter3/O_WRONLY.png)

# 3.7 read and write

> Full code in https://github.com/kimgb415/gaby-ldd/tree/Chapter3/read-and-write
...
![scull memory visualization](/assets/img/chapter3/visualization.png)
...
![test read and write](/assets/img/chapter3/test_read_and_write.png)

## Notes
- Patterns of `memset` following `kmalloc` is replaced by `kzalloc`
